...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=["lollms", "ollama", "openai", "azure_openai", "local"],
    ...
    # Allow disabling graph features
    args.graph_enabled = get_env_value("GRAPH_ENABLED", True, bool)
    ...
    args.llm_model = get_env_value("LLM_MODEL_NAME", "latest")
